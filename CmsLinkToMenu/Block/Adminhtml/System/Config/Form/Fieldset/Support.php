...
namespace Saurav\CmsLinkToMenu\Block\Adminhtml\System\Config\Form\Fieldset;
...
class Support extends \Magento\Backend\Block\Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'Saurav_CmsLinkToMenu::system/config/form/fieldset/support.phtml';
    ...
    public function getModuleVersion()
    {
        ...
        $v = "";
        if (isset($modules['Saurav_CmsLinkToMenu'])) {
            $v = $modules['Saurav_CmsLinkToMenu']['setup_version'];
        }
        return $v;
    }
}
