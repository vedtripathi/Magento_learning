...
[![Latest Stable Version](https://poser.pugx.org/Saurav/module-cmslinktomenu/v/stable)](https://packagist.org/packages/Saurav/module-cmslinktomenu)
[![Total Downloads](https://poser.pugx.org/Saurav/module-cmslinktomenu/downloads)](https://packagist.org/packages/Saurav/module-cmslinktomenu)
...
2. Copy the extension  to the `{magento2-root-dir}/app/code/Saurav/CmsLinkToMenu` 
3. Run the following series of command from SSH console of your server to install  the extension

#a)  Enable the extension : `php bin/magento module:enable Saurav_CmsLinkToMenu  --clear-static-content`
...
`composer require Saurav/module-cmslinktomenu`
 
 Package will be  clone at **vendor/Saurav/module-cmslinktomenu** at your
